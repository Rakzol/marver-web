...
<body>
    ...
    <div class="contenedor texto-centrado" >
        ...
        <div class="aliniacion-vertical" >
            ...
            <br>
            <p class="linea" >Fecha de certificación: </p><p class="linea" ><?php echo var_dump( $Comprobante->children('cfdi', true)->Complemento->children('tfd', true)->TimbreFiscal->attributes() ); ?></p>
            <br>
