                    ...
                    if( usuario_encontrado['posicion_final']['lat'] != usuario['latitud'] || usuario_encontrado['posicion_final']['lng'] != usuario['longitud']){
                        ...
                        fetch("https://routes.googleapis.com/directions/v2:computeRoutes", {
                            ...
                            headers: {
                                ...
                                "X-Goog-FieldMask": "routes.distanceMeters,routes.polyline.encodedPolyline,routes.legs.distanceMeters,routes.legs.steps.distanceMeters,routes.legs.steps.startLocation,routes.legs.steps.endLocation"
                            },
                            body: JSON.stringify({
                                origin: {
                                    location: {
