                ...
                if(usuario['ruta'] != undefined){
                    ...
                    for(let c = 0; c < usuario['polilineas'].length - 1; c++ ){
                        ...
                        if( metros_acumulados >= metros_recorridos){
                            ...
                            console.log(metros_polilinea / metros_recorridos_tramo);
                            let posicion_nueva = Esferica.interpolate( polilinea_inicial, polilinea_final, metros_polilinea / metros_recorridos_tramo );
