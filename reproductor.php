    ...
    try{
        ...
        for($c = 0; $c < count($pedidos); $c++){
            ...
            for($x = 1; $x < count($rutaRealizadaNor); $x++ ){
                ...
                if(\GeometryLibrary\SphericalUtil::computeDistanceBetween(['lat' => $rutaRealizadaNor[count($rutaRealizadaNor)-1]["lat"], 'lng' => $rutaRealizadaNor[count($rutaRealizadaNor)-1]["lng"]], ['lat' => $rutaRealizadaNor[$x]["lat"], 'lng' => $rutaRealizadaNor[$x]["lng"]]) >= 60 ){
                    $curl = curl_init("http://10.10.10.130:8082/ors/v2/directions/driving-car?start=".$rutaRealizadaNor[count($rutaRealizadaNor)-1]["lng"].",".$rutaRealizadaNor[count($rutaRealizadaNor)-1]["lat"]."&end=".$rutaRealizadaNor[$x]["lng"].",".$rutaRealizadaNor[$x]["lat"]);
