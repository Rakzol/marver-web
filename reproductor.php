    ...
    try{
        ...
        for($c = 0; $c < count($pedidos); $c++){
            ...
            for($x = 0; $x < count($rutaRealizadaNor) - 1; $x++ ){
                ...
                if(\GeometryLibrary\SphericalUtil::computeDistanceBetween(['lat' => $rutaRealizadaNor[$x]["lat"], 'lng' => $rutaRealizadaNor[$x]["lng"]], ['lat' => $rutaRealizadaNor[$x+1]["lat"], 'lng' => $rutaRealizadaNor[$x+1]["lng"]]) >= 100 ){
