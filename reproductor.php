    ...
    try{
        ...
        for($c = 0; $c < count($pedidos); $c++){
            ...
            for($x = 1; $x < count($rutaRealizadaNor); $x++ ){
                ...
                if(\GeometryLibrary\SphericalUtil::computeDistanceBetween(['lat' => $pedidos[$c]["rutaRealizada"][count($pedidos[$c]["rutaRealizada"])-1]["lat"], 'lng' => $pedidos[$c]["rutaRealizada"][count($pedidos[$c]["rutaRealizada"])-1]["lng"]], ['lat' => $rutaRealizadaNor[$x]["lat"], 'lng' => $rutaRealizadaNor[$x]["lng"]]) >= 100 ){
