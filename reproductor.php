<?php
    try{
        ...
        $preparada = $conexion->prepare("SELECT latitud, longitud, velocidad FROM posiciones WHERE fecha >= :dia_inicial AND fecha < DATEADD(DAY, 1, :dia_final) AND usuario = :repartidor ORDER BY fecha ASC");
