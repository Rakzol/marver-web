    ...
    <div class="d-flex h-100 flex-column">
        ...
        <div class="card text-center border-0">
            ...
            <div class="card-body">
                ...
                <input type="range" onchange="actualizar_todo();" style="max-width: 490px;" class="form-range d-block m-auto" min="0" max="1" value="0" id="cursor">
                ...
                <a class="btn btn-primary" href="https://www.marverrefacciones.mx/mapa" style="min-width: 120px;" target="_blank" >Rastreo</a>
                ...
                <a class="btn btn-primary" href="https://www.marverrefacciones.mx/excesos" style="min-width: 120px;" target="_blank"  >Excesos</a>
            </div>
        </div>
