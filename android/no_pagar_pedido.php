...
try {
    ...
    //HOT FIX Extra3 = 1
    $preparada = $conexion->prepare("UPDATE EnvioPedidoCliente SET Extra3 = 1, Extra2 = 'ENTREGADO NO PAGADO' WHERE Pedido = :pedido AND Responsable = :repartidor AND Extra2 = 'EN RUTA'");
    $preparada->bindValue(':pedido', $_POST['folio']);
    $preparada->bindValue(':repartidor', $_POST['clave']);
    $preparada->execute();
