<?php
    try{
        ...
        $preparada = $conexion->prepare("
            ...
            WHERE
            1 = 2 AND EnvioPedidoCliente.Fecha = CONVERT(DATE, GETDATE()) AND ( EnvioPedidoCliente.Extra2 LIKE '%-FINALIZADO' OR EnvioPedidoCliente.Extra2 = 'NO ENTREGADO-REENVIADO' )
