<?php
    try{
        ...
        $preparada = $datos['conexion_catalogo_principal']->prepare("EXEC consultar_productos @marca = :marca, @año = :anio, @modelo = :modelo, @motor = :motor, @sistema = :sistema, @subsistema = :subsistema");
